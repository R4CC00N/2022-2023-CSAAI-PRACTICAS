...
const gui = {
  ...
  node : document.getElementById("nNodo"),
...
const sendImage = () => {
  ...
  state.loop = setInterval(() => {
   ...
   //}
    ...
    //console.log("time",(state.netDelay/1000)* state.node);
    // TIEMPO DE RETARDO TOTAL
  }, (state.netDelay/1000)* state.node )
}
